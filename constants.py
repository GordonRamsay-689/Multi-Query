...
FORMAT_FLAG = '--format:'
DUMP_FLAG = '--dump:'
VALID_FLAGS = [ADD_FLAG, DUMP_FLAG, REMOVE_FLAG, STREAM_FLAG, DISPLAY_FLAG, SYSMSG_FLAG, CLEAR_FLAG, FORMAT_FLAG] 
NO_ARGS_FLAGS = [DISPLAY_FLAG, CLEAR_FLAG, FORMAT_FLAG]
...
TYPES = [TYPE_GEMINI, TYPE_GOOGLE, TYPE_OPENAI, TYPE_TEST]
